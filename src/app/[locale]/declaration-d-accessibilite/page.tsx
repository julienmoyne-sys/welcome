...
const PATH = "/declaration-d-accessibilite";
...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    locale,
    path: PATH,
    namespace: "metadata.accessibilite",
    twitterCard: "summary",
  });
}
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations("metadata.accessibilite");

  return (
    <LegalPage
      namespace="legal.accessibilite"
      jsonLd={
        <JsonLd
